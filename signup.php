...
if(isset($_GET["UserCreatedSuccessfully"])){
    $item_id = $_SESSION["item_id"];
    $id = $_SESSION["id"];
    echo header("Location:login2.php?UserCreatedSuccessfully&item_id=$item_id&id=$id");
} 
?>
...
<section class="form-input" style="margin-bottom:200px;">
    ...
    <div class="form-floating">
        <input type="text" name="firstname" value="<?=old_value("firstname")?>" id="floating-firstname" class="form-control" placeholder="Firstname">
        <label for="floating-firstname">Firstname</label>
    </div>
    <div class="form-floating">
        <input type="text" name="others" value="<?=old_value("others")?>" id="floating-others" class="form-control" placeholder="Others...">
    ...
    <div class="form-floating">
        <input type="password" name="rptpassword" id="floating-rptpassword" class="form-control" placeholder="Repeat Password">
...
<div class="text-center text-muted">Already Have an Account ? <a href="login2.php" style="text-decoration: none;">Login</a></div>
